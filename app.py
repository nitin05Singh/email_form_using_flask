...
@app.route('/')
def index():
    return render_template('index.html')  # The HTML file containing your form.
...
def submit():
    ...
    msg = MIMEMultipart()
    msg['From'] = 'nitinsingh9765@gmail.com'  # Your email address
    ...
    try:
        ...
        server.starttls()
        server.login('nitinsingh9765@gmail.com', 'gmty qidd lhmd jfya') # Your email and password
